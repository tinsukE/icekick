...
internal class LateSavedProperty<T : B, B>(var bundler: Bundler<B>,
    ...
    override fun getValue(thisRef: Any, property: KProperty<*>): T {
        val value = value ?: throw UninitializedPropertyAccessException("SavedProperty was accessed before it was set")
        return value
    }
